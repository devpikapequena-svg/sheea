...
import { produtosMelhores } from "@/data/produtosMelhores";
import Image from "next/image";

export default function ProdutosMelhores() {
  return (
    <section
      className="py-12"
      style={{ backgroundColor: "#e5ded4" }} // 🎨 cor aplicada
    >
